...
values (100001, '김행복', '010-1111-2222', '서울 동대문구 휘경1동', '20200102', 'A', '10');
insert into tbl_member
values (100002, '이축복', '010-1111-3333', '서울 동대문구 휘경2동', '20200103', 'B', '10');
insert into tbl_member
values (100003, '장믿음', '010-1111-4444', '울릉도 울릉읍 독도1리', '20200104', 'B', '30');
insert into tbl_member
values (100004, '최사랑', '010-1111-5555', '울릉도 울릉읍 독도2리', '20200105', 'A', '30');
insert into tbl_member
values (100005, '진평화', '010-1111-6666', '제주도 제주시 외나무골', '20200106', 'B', '60');
insert into tbl_member
values (100006, '차공단', '010-1111-7777', '제주도 제주시 감나무골', '20200107', 'C', '60');
