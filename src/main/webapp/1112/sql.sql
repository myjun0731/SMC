...
insert into tbl_goods_01 values('110001','���',1050,750, to_date('20190302','YYYYMMDD'));
insert into tbl_goods_01 values('110002','��',1300,800, to_date('20190302','YYYYMMDD'));
insert into tbl_goods_01 values('110003','����',2000,1700, to_date('20190302','YYYYMMDD'));
insert into tbl_goods_01 values('110004','ź������',900,750, to_date('20190302','YYYYMMDD'));
insert into tbl_goods_01 values('110005','�ﰢ���',750,300, to_date('20190302','YYYYMMDD'));
insert into tbl_goods_01 values('110006','���ݸ�',1500,1300, to_date('20190302','YYYYMMDD'));
insert into tbl_goods_01 values('110007','���',850,600, to_date('20190302','YYYYMMDD'));
...
to_char(NVl(sum(decode(sa.pay_type,'01', sa.sale_cnt, null,0)*g.goods_price),0),'999,999') || '��' as ���ݸ���,
to_char(NVl(sum(decode(sa.pay_type,'02', sa.sale_cnt, null,0)*g.goods_price),0),'999,999') || '��' as ī�����,
to_char(sum(sa.sale_cnt * g.goods_price),'999,999') || '��' as �Ѹ���
...
select decode(sa.sale_fg,'1','�ɸ�', '2', '�Ǹ����'), sa.sale_no,
to_char(sa.sale_ymd, 'YYYY-MM-DD'), st.store_nm,
sa.sale_cnt,
to_char(g.goods_price * sa.sale_cnt, '999,999') || '��',
decode(sa.pay_type,'01','����','02','ī��')
from sale_tbl_003 sa, store_tbl_003 st, tbl_goods_01 g
